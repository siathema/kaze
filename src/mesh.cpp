...
Mesh Gen_Mesh(Array<Vertex> &verts, Array<u32> &indices) {
    ...
    // vertex positions
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 11 * sizeof(r32),
                          (GLvoid *)0);
    glEnableVertexAttribArray(0);
    // texture coordinates
    glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, 11 * sizeof(r32),
                          (GLvoid *)offsetof(Vertex, u));
    glEnableVertexAttribArray(1);
    // normal vectors
    glVertexAttribPointer(2, 3, GL_FLOAT, GL_FALSE, 11 * sizeof(r32),
                          (GLvoid *)offsetof(Vertex, nx));
    glEnableVertexAttribArray(2);
    // tangent vectors
    glVertexAttribPointer(3, 3, GL_FLOAT, GL_FALSE, 11 * sizeof(r32),
